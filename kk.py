...
#===============================================================================#
line = LINE("")
#line = LINE("EzKgz9Op5vHxOREceLac./i/5rYKTg6f/CZ30PHlPRa.Fvx/aGkC6gdoV10Kqe70XHGHQ5D05KXzB9jzbjd/3zw=")
...
RfuBot=[lineMID]
Family=["uf88fb947292d1ba17e733df4a612e9ac",lineMID]
...
settings = {
    ...
    "Respontag":" 𝕒𝕦𝕥𝕠 𝕥𝕒𝕘 𝕓𝕪 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "ResponPM":" 𝕒𝕦𝕥𝕠 𝕣𝕖𝕤𝕡𝕠𝕟 𝕓𝕪 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "message":" 𝕒𝕦𝕥𝕠 𝕓𝕝𝕠𝕔𝕜 𝕓𝕪 𝕤𝕖𝕝𝕗𝕓𝕠𝕥",
    "comment":" 𝕤𝕖𝕝𝕗𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "comment1":" โสดจ้าโสด 𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "Wc":" 𝕨𝕖𝕝 𝕔𝕠𝕞𝕖 ",
    "bye":" 𝕓𝕪𝕖 𝕓𝕪𝕖 ",
    "add":" 𝕒𝕦𝕥𝕠 𝕒𝕕𝕕 𝕓𝕪 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "kick":" 𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "c":" 𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "s":"",
    "userAgent": [
...
#==============================================================================================================
#==============================================================================================================
def bounzen(json_data):
    headers = { 
         "Content-Type": "application/json" 
    } 
    jsondata = json_data
    resp = requests.post("https://pasunx.tk/api/bounzen.php?json={}".format(jsondata))
    #client.sendMessage(jsondata["chat_id"],"ไม่สามารถส่ง "+jsondata["messages"]["type"]+" message โดยใช้ "+jsondata["line_application"]+" ได้")
    #print("CANNOT SEND " + jsondata["messages"]["type"].upper() + " MESSAGE.")
            ...
            if lineMID in op.param3:
                ...
                if settings["autoJoin"] == True:
                    ...
                    if len(G.members) <= settings["autoCancel"]["members"]:
                        ...
                        print ("[ 13 ] ยกเลิกกลุ่มรันอัตโนมัติ")
            else:
...
#==============================================================================#
                if msg.text.lower() == 'ขอเสียง fc':
                    ...
                    for ls in lists:
                        anu = ls
                        mid  = "{}".format(ls)
                        text = "กรี๊ดด..พี่วีขอลายเซ็นหน่อย.💖"
                ...
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『𝕥𝕖𝕤𝕥 𝕤𝕡𝕖𝕖𝕕 𝕓𝕠𝕥』")
...
#-------------------------------------------------------------------------------------------------------------
                            ...
                            dataProfile = [
                                {
                                    ...
                                    "hero": {
                                            "type": "image",
                                            "url": "https://img.live/images/2019/03/15/1552629481995.jpg",
                                            "size": "full",
                                            "aspectRatio": "1:1",
                                            "aspectMode": "fit",
                                            "action": {
                                                "type": "uri",
                                                "uri": "http://line.me/ti/p/%40dhf1564b"
                                            }
                                    },
                                    "footer": {
                                        "type": "box",
                                        ...
                                        "contents": [
                                          {
                                            ...
                                            "action": {
                                              "type": "uri",
                                              "label": "สมัครสมาชิก",
                                             "uri": "http://line.me/ti/p/%40gkc1031y"
                                            }
                                          }
                                        ]
                                      }
                                },
                                {
                                    ...
                                    "hero": {
                                            "type": "image",
                                            "url": "https://img.live/images/2019/03/14/1552557193224.jpg",
                                            "size": "full",
                                            "aspectRatio": "1:1",
                                            "aspectMode": "fit",
                                            "action": {
                    ...
                    line.sendMessage(msg.to,"「✮ 𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖 ✮」")                    
...
#-----------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"✮ 𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖 ✮" +datetime.today().strftime('%H:%M:%S')+ "™") 
...
#=============COMMAND PROTECT=========================#
                    ...
                    if RfuProtect["protect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกัน   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกัน   ")
                    else:
                    ...
                    if RfuProtect["protect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกัน   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกัน   ")
                    else:
                    ...
                    if RfuProtect["cancelprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันยกเลิกเชิญ   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันยกเลิกเชิญ   ")
                    else:
                    ...
                    if RfuProtect["cancelprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันยกเลิกเชิญ   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันยกเลิกเชิญ   ")
                    else:
                    ...
                    if RfuProtect["inviteprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันยกเชิญ   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันยกเชิญ   ")
                    else:
                    ...
                    if RfuProtect["inviteprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันยกเชิญ   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันยกเชิญ   ")
                    else:
                    ...
                    if RfuProtect["linkprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันลิ้ง   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันลิ้ง   ")
                    else:
                    ...
                    if RfuProtect["linkprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันลิ้ง   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันลิ้ง   ")
                    else:
                    ...
                    if RfuProtect["Protectguest"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันสมาชิก   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันสมาชิก   ")
                    else:
                    ...
                    if RfuProtect["Protectguest"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันสมาชิก   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันสมาชิก   ")
                    else:
                    ...
                    if RfuProtect["Protectjoin"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันคนเข้า   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันคนเข้า   ")
                    else:
                    ...
                    if RfuProtect["Protectjoin"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันคนเข้า   ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันคนเข้า   ")
                    else:
                    ...
                    if RfuProtect["inviteprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"✰เปิดป้องกันทั้งหมด✰")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"✰เปิดป้องกันทั้งหมด✰")
                    else:
                        RfuProtect["inviteprotect"] = True
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันเชิญ")
                    if RfuProtect["cancelprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันยกเลิกเชิญ")
                        else:
                    ...
                    if RfuProtect["protect"] == True:
                        ...
                        RfuProtect["protect"] = True
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันเตะ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันเตะ")
                    if RfuProtect["linkprotect"] == True:
                        if settings["lang"] == "JP":
                    ...
                    if RfuProtect["Protectguest"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันกลุ่ม")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันกลุ่ม")
                    else:
                        RfuProtect["Protectguest"] = True
                    ...
                    if RfuProtect["Protectjoin"] == True:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันบุคคลภายน้อกเข้ากลุ่ม")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"เปิดป้องกันบุคคลภายน้อกเข้ากลุ่ม")
                    else:
                        RfuProtect["Protectjoin"] = True
                    ...
                    if RfuProtect["inviteprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"✰ปิดป้องกันทั้งหมด✰")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"✰ปิดป้องกันทั้งหมด✰")
                    else:
                        RfuProtect["inviteprotect"] = False
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันเชิญ")
                    if RfuProtect["cancelprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันยกเชิญ")
                        else:
                    ...
                    if RfuProtect["protect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันเตะ")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันเตะ")
                    else:
                        RfuProtect["protect"] = False
                    ...
                    if RfuProtect["linkprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันเปิดลิ้ง")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันเปิดลิ้ง")
                    else:
                        RfuProtect["linkprotect"] = False
                    ...
                    if RfuProtect["Protectguest"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันกลุ่ม")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันกลุ่ม")
                    else:
                        RfuProtect["Protectguest"] = False
                    ...
                    if RfuProtect["Protectjoin"] == False:
                        if settings["lang"] == "JP":
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันบุคคลภายน้อกเข้ากลุ่ม")
                        else:
                            line.sendReplyMessage(msg.id, msg.to,"ปิดป้องกันบุคคลภายน้อกเข้ากลุ่ม")
                    else:
                        RfuProtect["Protectjoin"] = False
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『𝕤𝕖𝕝𝕗 𝕓𝕠𝕥𝕝𝕚𝕟𝕖』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
        ...
        if op.type == 26:
            ...
            if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                if msg.toType == 0:
                    ...
                    to = receiver
                if msg.text in ["พี่วี","อือ","อื้อๆ","อ่า"]:
        ...
        if op.type == 26:
            ...
            if settings ["Aip"] == True:
            	if msg.text in ["cleanse","group cleansed.","mulai",".winebot",".kickall","mayhem","kick on","Kick","!kickall","nuke","บิน","Kick","กระเด็น","หวด","เซลกากจัง","เตะ",".","ปลิว"]:
                    ...
                    line.sendMessage(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก (｀・ω・´)")
            if settings ["Aip"] == True:
                if msg.text in ["ควย","หี","แตด","เย็ดแม่","เย็ดเข้","ค.วย","สัส","เหี้ย","ไอ้เหี้ย","พ่อมึงตาย","ไอ้เลว","ระยำ","ชาติหมา","หน้าหี","เซลกาก","พ่องตาย","ส้นตีน","แม่มึงอ่ะ","แม่มึงดิ","พ่อมึงดิ"]:
                    line.kickoutFromGroup(receiver,[sender])
                    line.sendMessage(msg.to,"ตรวจพบคำพูดหยาบคายไม่สุภาพ จำเป็นต้องนำออกเพื่อความสงบสุขของสมาชิก (｀・ω・´)")
            if settings ["Api"] == True:
            	if msg.text in ["99","189","285","19900","20100","20180","30100","29900","39800","39850","39900"]:
                    line.kickoutFromGroup(receiver,[sender])
                    line.sendMessage(msg.to,"ตรวจพบคำสั่งนับเลข จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก (｀・ω・´)")
            if settings ["Api"] == True:
                if msg.text in ["ป๋า","พี่สาว","พี่ชาย","พี่","ทวด","ยาย","ตา"]:
                    line.sendMessage(msg.to, "จ๋าเรียกเค้าทำไมคิดถึงเค้าหรา😆😆")
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["55","555","5555","55555","55+","555+","5555+","ขำ",".ขำ"]:
                    line.sendMessage(msg.to, "ขำไร ขำด้วยคนดิ😆😆")
