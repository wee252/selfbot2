...
botStart = time.time()
#===============================================================================#
#line = LINE("EARUZ16FQBNZ8AaWKY42.zbQcgx5bvy+akNzScq2qOG.NIaGb0Jn8Lk5gnBgfuVAWjlC+c5cEsJPuXMyYlnDqoU=")
line = LINE("EBLNDpJiFESq6ZoqRcjb.HDDM3SX1y+gILBRzB+4P/W.fRdZxFc9mI+znBz1nBuDpXjAJ4H+vJuF/f/0z8dzXAI=")
...
#-------------------------------------------------------------------------------------------------------------
                	...
                	data = {
                		"cc": "uf88fb947292d1ba17e733df4a612e9ac",
                		"to": to,
                		"messages": [
	                    {
	                      "type": "template",
...
#===========ชุด API คำสั่งใช้งานบอทสิริเชนวี10 ========================== 
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["ป๊าวี","ลุงวี","พี่วี่","เพื่อน","จาร์ย","อาจาร์ย","เฮีย","วี"]:
